...
function toggleHeaderSearch() {
  ...
  if (headerSearchOpen.value) {
    nextTick(() => document.getElementById('header-search-input')?.querySelector('input')?.focus())
  }
}
      ...
      <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div class="relative" data-lang-switcher>
          ...
          <Transition enter-active-class="transition ease-out duration-150" enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
            <ul v-show="langOpen" role="listbox" class="absolute right-0 top-full mt-2 w-40 bg-white rounded-xl shadow-xl border border-gray-100 py-1.5 z-[60]">
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between h-[70px]">
          ...
          <Link href="/" class="flex-shrink-0">
            <img src="/images/logo.png" alt="4B Grup Endüstriyel Ticaret" class="h-[52px] w-auto">
          </Link>
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="relative" data-header-search>
              <button
                ...
                :aria-label="trans('common.search_aria')"
                aria-haspopup="true"
                :aria-expanded="headerSearchOpen"
                class="p-2 text-gray-500 hover:text-[#0E7A8C] hover:bg-[#F4F6F9] rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M11 19a8 8 0 100-16 8 8 0 000 16z"/>
                </svg>
              </button>
              <Transition enter-active-class="transition ease-out duration-150" enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
                <div v-show="headerSearchOpen" id="header-search-input" class="absolute right-0 top-full mt-2 w-72 sm:w-80 z-[60]">
                  <ProductSearch />
                </div>
              </Transition>
            </div>
    ...
    <footer class="bg-[#0e1e3d] text-white">
      <div class="max-w-7xl mx-auto px-6 pt-16 pb-10 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div class="md:col-span-1">
          <img src="/images/logo-dark.png" alt="4B Grup" class="h-[52px] w-auto mb-5 opacity-90">
