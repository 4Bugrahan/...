...
// Mobilde kategori listesi varsayılan kapalı, "Kategoriler" butonuyla açılır
const mobileFiltersOpen = ref(false)
// Sidebar'da hangi ana kategorinin alt kategorileri açık (yalnızca UI durumu, sayfa navigasyonu değil)
