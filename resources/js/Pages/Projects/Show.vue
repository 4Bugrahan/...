        ...
        <section class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <!-- Bilgi -->
                    <div>
                        <span v-if="localizedProject.location" class="flex items-center gap-1.5 w-fit text-xs font-semibold text-[#0E7A8C] bg-[#0E7A8C]/10 px-3 py-1.5 rounded-full mb-4">
