...
import { _ as _sfc_main$1, a as _sfc_main$2 } from "./AppLayout-CAQypwC2.js";
            ...
            ssrRenderList(displayCategories.value, (category) => {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative overflow-hidden aspect-square"${_scopeId2}><img${ssrRenderAttr("src", FRAME_IMAGE)} alt="" draggable="false" class="absolute inset-0 w-full h-full object-cover pointer-events-none select-none"${_scopeId2}><img${ssrRenderAttr("src", getCoverImage(category.slug))}${ssrRenderAttr("alt", category.name)} draggable="false" class="absolute inset-[7%] w-[86%] h-[86%] object-contain outline-none transition-transform duration-500 group-hover:scale-105"${_scopeId2}></div><div class="px-4 py-3" style="${ssrRenderStyle({ "border-top": "1px solid #f0f1f3" })}"${_scopeId2}><h3 class="font-bold text-sm leading-snug truncate" style="${ssrRenderStyle({ "color": "#1B3163" })}"${_scopeId2}>${ssrInterpolate(category.name)}</h3><span class="text-xs font-medium" style="${ssrRenderStyle({ "color": "#8b93a3" })}"${_scopeId2}>${ssrInterpolate(category.total_products_count ?? category.products_count ?? 0)} ${ssrInterpolate(unref(trans)("common.product_unit"))}</span></div>`);
                  } else {
                    return [
