            ...
            ssrRenderList(displayPartners.value, (partner) => {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(partner.website ? "a" : "div"), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (partner.logo_url) {
                      _push3(`<img${ssrRenderAttr("src", partner.logo_url)}${ssrRenderAttr("alt", partner.name)} loading="lazy" class="w-full h-14 object-contain transition-all duration-300"${_scopeId2}>`);
                    } else {
