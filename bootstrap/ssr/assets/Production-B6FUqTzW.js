    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="bg-gradient-to-br from-[#1B3163] to-[#1B3163] py-20" data-v-3882188b${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-3882188b${_scopeId}><div class="max-w-3xl" data-v-3882188b${_scopeId}><h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6 leading-tight" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.hero_title"))}</h1><p class="text-white/70 text-lg leading-relaxed" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.hero_desc"))}</p></div></div></section><section class="bg-white py-20" data-v-3882188b${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-3882188b${_scopeId}><div class="relative w-full aspect-[16/8] rounded-2xl overflow-hidden border border-gray-100" data-v-3882188b${_scopeId}>`);
            if (laserMedia.value.video) {
              _push2(`<video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline data-v-3882188b${_scopeId}><source${ssrRenderAttr("src", laserMedia.value.video)} type="video/mp4" data-v-3882188b${_scopeId}></video>`);
            } else if (laserMedia.value.image) {
              _push2(`<img${ssrRenderAttr("src", laserMedia.value.image)}${ssrRenderAttr("alt", unref(trans)("production.laser_title"))} class="absolute inset-0 w-full h-full object-cover" data-v-3882188b${_scopeId}>`);
            } else {
              _push2(`<div class="absolute inset-0 bg-gradient-to-br from-[#1B3163]/5 to-[#0E7A8C]/10" data-v-3882188b${_scopeId}><div class="absolute inset-0 flex flex-col items-center justify-center gap-4" data-v-3882188b${_scopeId}><div class="w-20 h-20 rounded-2xl bg-white border border-gray-200 flex items-center justify-center shadow-sm" data-v-3882188b${_scopeId}><svg class="w-10 h-10 text-[#0E7A8C]" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3882188b${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" data-v-3882188b${_scopeId}></path></svg></div><p class="text-[#1B3163]/60 font-semibold text-sm tracking-wide" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.laser_label"))}</p></div></div>`);
            }
            _push2(`</div></div></section><section class="bg-white py-20 border-t border-gray-100" data-v-3882188b${_scopeId}><div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section1_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163] mb-6" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section1_title"))}</h2><p class="text-[#666] text-lg leading-relaxed" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section1_text"))}</p></div></section><section class="bg-white py-20 border-t border-gray-100" data-v-3882188b${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-3882188b${_scopeId}><div class="mb-12 text-center" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.cards_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163]" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.cards_title"))}</h2></div><div class="grid sm:grid-cols-3 gap-6" data-v-3882188b${_scopeId}><!--[-->`);
            ssrRenderList(productionCards, (card) => {
              _push2(`<div class="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-[#3DAFC4]/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1" data-v-3882188b${_scopeId}><div class="relative aspect-[4/3]" data-v-3882188b${_scopeId}>`);
              if (card.image) {
                _push2(`<img${ssrRenderAttr("src", card.image)}${ssrRenderAttr("alt", unref(trans)(card.titleKey))} class="absolute inset-0 w-full h-full object-cover" data-v-3882188b${_scopeId}>`);
              } else {
                _push2(`<div class="absolute inset-0 bg-gradient-to-br from-[#1B3163]/5 to-[#0E7A8C]/10 flex items-center justify-center" data-v-3882188b${_scopeId}><div class="w-14 h-14 bg-[#0E7A8C]/10 group-hover:bg-[#0E7A8C] rounded-2xl flex items-center justify-center transition-colors duration-300" data-v-3882188b${_scopeId}><svg class="w-7 h-7 text-[#0E7A8C] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3882188b${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"${ssrRenderAttr("d", card.icon)} data-v-3882188b${_scopeId}></path></svg></div></div>`);
              }
              _push2(`<span class="absolute top-4 left-4 w-8 h-8 rounded-full bg-[#1B3163] text-white text-sm font-bold flex items-center justify-center" data-v-3882188b${_scopeId}>${ssrInterpolate(card.key)}</span></div><div class="p-6" data-v-3882188b${_scopeId}><h3 class="text-lg font-black text-[#1B3163] mb-2" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)(card.titleKey))}</h3><p class="text-sm text-[#666] leading-relaxed" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)(card.descKey))}</p></div></div>`);
            });
            _push2(`<!--]--></div></div></section><section class="bg-white py-20 border-t border-gray-100" data-v-3882188b${_scopeId}><div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section2_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163] mb-6" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section2_title"))}</h2><p class="text-[#666] text-lg leading-relaxed" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section2_text"))}</p></div></section><section class="bg-white py-20 border-t border-gray-100" data-v-3882188b${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-3882188b${_scopeId}><div class="mb-10" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.bend_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163]" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.bend_title"))}</h2></div><div class="relative w-full aspect-[16/8] rounded-2xl overflow-hidden border border-gray-100" data-v-3882188b${_scopeId}>`);
            if (bendMedia.value.video) {
              _push2(`<video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline data-v-3882188b${_scopeId}><source${ssrRenderAttr("src", bendMedia.value.video)} type="video/mp4" data-v-3882188b${_scopeId}></video>`);
            } else if (bendMedia.value.image) {
              _push2(`<img${ssrRenderAttr("src", bendMedia.value.image)}${ssrRenderAttr("alt", unref(trans)("production.bend_title"))} class="absolute inset-0 w-full h-full object-cover" data-v-3882188b${_scopeId}>`);
            } else {
              _push2(`<div class="absolute inset-0 bg-gradient-to-br from-[#1B3163]/5 to-[#0E7A8C]/10" data-v-3882188b${_scopeId}><div class="absolute inset-0 flex flex-col items-center justify-center gap-4" data-v-3882188b${_scopeId}><div class="w-20 h-20 rounded-2xl bg-white border border-gray-200 flex items-center justify-center shadow-sm" data-v-3882188b${_scopeId}><svg class="w-10 h-10 text-[#0E7A8C]" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3882188b${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" data-v-3882188b${_scopeId}></path></svg></div><p class="text-[#1B3163]/60 font-semibold text-sm tracking-wide" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.bend_label"))}</p></div></div>`);
            }
            _push2(`</div></div></section><section class="bg-white py-20 border-t border-gray-100" data-v-3882188b${_scopeId}><div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section3_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163] mb-6" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section3_title"))}</h2><p class="text-[#666] text-lg leading-relaxed" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.section3_text"))}</p></div></section><section class="bg-white py-20 border-t border-gray-100 overflow-hidden" data-v-3882188b${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10" data-v-3882188b${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.gallery_label"))}</p><h2 class="text-3xl sm:text-4xl font-black text-[#1B3163]" data-v-3882188b${_scopeId}>${ssrInterpolate(unref(trans)("production.gallery_title"))}</h2></div><div class="relative" data-v-3882188b${_scopeId}><div class="pointer-events-none absolute left-0 top-0 bottom-0 w-20 z-10" style="${ssrRenderStyle({ "background": "linear-gradient(to right, #ffffff, transparent)" })}" data-v-3882188b${_scopeId}></div><div class="pointer-events-none absolute right-0 top-0 bottom-0 w-20 z-10" style="${ssrRenderStyle({ "background": "linear-gradient(to left, #ffffff, transparent)" })}" data-v-3882188b${_scopeId}></div><div class="marquee-container group/marquee" data-v-3882188b${_scopeId}><div class="marquee-track flex gap-4" data-v-3882188b${_scopeId}><!--[-->`);
            ssrRenderList(2, (n) => {
              _push2(`<!--[--><!--[-->`);
              ssrRenderList(gallerySlides.value, (slide, i) => {
                _push2(`<div class="flex-shrink-0 w-72 sm:w-80 aspect-[4/3] rounded-2xl overflow-hidden border border-gray-100 relative" data-v-3882188b${_scopeId}>`);
                if (slide.image) {
                  _push2(`<img${ssrRenderAttr("src", slide.image)}${ssrRenderAttr("alt", `${unref(trans)("production.gallery_title")} ${i + 1}`)} class="absolute inset-0 w-full h-full object-cover" data-v-3882188b${_scopeId}>`);
                } else {
                  _push2(`<div class="absolute inset-0 bg-gradient-to-br from-[#f4f5f6] to-gray-100 flex items-center justify-center" data-v-3882188b${_scopeId}><svg class="w-10 h-10 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3882188b${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" data-v-3882188b${_scopeId}></path></svg></div>`);
                }
                _push2(`</div>`);
              });
              _push2(`<!--]--><!--]-->`);
              ...
              createVNode("section", { class: "bg-gradient-to-br from-[#1B3163] to-[#1B3163] py-20" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "max-w-3xl" }, [
                    createVNode("h1", { class: "text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6 leading-tight" }, toDisplayString(unref(trans)("production.hero_title")), 1),
                    createVNode("p", { class: "text-white/70 text-lg leading-relaxed" }, toDisplayString(unref(trans)("production.hero_desc")), 1)
                  ])
                ])
              ]),
...
const Production = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3882188b"]]);
export {
