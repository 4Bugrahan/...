  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/images/logo.png" alt="4B Grup Endüstriyel Ticaret" class="h-14 w-auto"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: "/images/logo.png",
