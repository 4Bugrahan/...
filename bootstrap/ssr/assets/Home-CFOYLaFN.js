...
import { _ as _sfc_main$1 } from "./AppLayout-DYdQlh9Z.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="relative h-[calc(100vh-70px)] md:h-[calc(100vh-108px)]" data-v-dd0c54e3${_scopeId}><div class="hidden lg:flex h-full" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(heroPanels.value, (panel, i) => {
              _push2(`<div class="relative overflow-hidden cursor-pointer transition-all duration-700 ease-in-out" style="${ssrRenderStyle(`flex: ${activePanel.value === i ? 1.7 : 1};`)}" data-v-dd0c54e3${_scopeId}>`);
              if (panel.video) {
                _push2(`<video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline${ssrRenderAttr("poster", panel.videoPoster || void 0)} data-v-dd0c54e3${_scopeId}><source${ssrRenderAttr("src", panel.video)} type="video/mp4" data-v-dd0c54e3${_scopeId}></video>`);
              } else {
                _push2(`<div class="absolute inset-0 transition-all duration-700" style="${ssrRenderStyle(panel.image ? `background-image: url('${panel.image}'); background-size: cover; background-position: center;` : `background: ${panel.bg};`)}" data-v-dd0c54e3${_scopeId}></div>`);
              }
              if (!panel.image && !panel.video) {
                _push2(`<div class="absolute inset-0 opacity-[0.04]" style="${ssrRenderStyle({ "background-image": "radial-gradient(rgba(255,255,255,0.8) 1px, transparent 1px)", "background-size": "28px 28px" })}" data-v-dd0c54e3${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (!panel.image || panel.video) {
                _push2(`<div class="absolute inset-0" style="${ssrRenderStyle({ "background": "linear-gradient(to top, rgba(0,8,22,0.90) 0%, rgba(0,8,22,0.30) 55%, transparent 100%)" })}" data-v-dd0c54e3${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (i > 0) {
                _push2(`<div class="absolute left-0 top-0 bottom-0 w-px bg-white/12 z-10" data-v-dd0c54e3${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="${ssrRenderClass([activePanel.value === i ? "bg-[#3DAFC4]" : "bg-white/8", "absolute top-0 left-0 right-0 h-[3px] z-10 transition-colors duration-500"])}" data-v-dd0c54e3${_scopeId}></div><div class="relative z-10 h-full flex flex-col justify-end px-14 pb-16" data-v-dd0c54e3${_scopeId}><h2 class="${ssrRenderClass([activePanel.value === i ? "text-5xl" : "text-2xl", "text-white font-black leading-[1.05] mb-6 transition-all duration-700"])}" data-v-dd0c54e3${_scopeId}>${panel.title.replace(/\n/g, "<br>") ?? ""}</h2><div class="overflow-hidden transition-all duration-700" style="${ssrRenderStyle(activePanel.value === i ? "max-height: 100px; opacity: 1; margin-bottom: 32px;" : "max-height: 0; opacity: 0; margin-bottom: 0;")}" data-v-dd0c54e3${_scopeId}><p class="text-white/55 text-[15px] leading-relaxed max-w-md" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(panel.desc)}</p></div><div class="overflow-hidden transition-all duration-700" style="${ssrRenderStyle(activePanel.value === i ? "max-height: 60px; opacity: 1;" : "max-height: 0; opacity: 0;")}" data-v-dd0c54e3${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(panel.btn)} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></div><div class="flex lg:hidden flex-col h-full" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(heroPanels.value, (panel, i) => {
              _push2(`<div class="relative flex-1 overflow-hidden" style="${ssrRenderStyle(!panel.video && panel.image ? `background-image: url('${panel.image}'); background-size: cover; background-position: center;` : !panel.video ? `background: ${panel.bg};` : "")}" data-v-dd0c54e3${_scopeId}>`);
              if (panel.video) {
                _push2(`<video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline${ssrRenderAttr("poster", panel.videoPoster || void 0)} data-v-dd0c54e3${_scopeId}><source${ssrRenderAttr("src", panel.video)} type="video/mp4" data-v-dd0c54e3${_scopeId}></video>`);
              } else {
                _push2(`<!---->`);
              ...
              if (!panel.image && !panel.video) {
                _push2(`<div class="absolute inset-0 opacity-[0.04]" style="${ssrRenderStyle({ "background-image": "radial-gradient(rgba(255,255,255,0.8) 1px, transparent 1px)", "background-size": "20px 20px" })}" data-v-dd0c54e3${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (!panel.image || panel.video) {
                _push2(`<div class="absolute inset-0" style="${ssrRenderStyle({ "background": "linear-gradient(to top, rgba(0,8,22,0.85) 0%, rgba(0,8,22,0.40) 100%)" })}" data-v-dd0c54e3${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="relative z-10 h-full flex flex-col justify-end px-8 pb-10" data-v-dd0c54e3${_scopeId}><h2 class="text-white font-black text-3xl leading-tight mb-5" data-v-dd0c54e3${_scopeId}>${panel.title.replace(/\n/g, "<br>") ?? ""}</h2>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: panel.href,
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(panel.btn)} <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(panel.btn) + " ", 1),
                      (openBlock(), createBlock("svg", {
            ...
            _push2(`<!--]--></div><div class="absolute bottom-0 left-0 right-0 z-20 pointer-events-none hidden lg:block" data-v-dd0c54e3${_scopeId}><svg viewBox="0 0 1440 57" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="${ssrRenderStyle({ "display": "block", "width": "100%", "height": "57px" })}" data-v-dd0c54e3${_scopeId}><path d="M0,57 L0,34 L693,34 C708,34 714,3 720,0 C726,3 732,34 747,34 L1440,34 L1440,57 Z" fill="#ffffff" data-v-dd0c54e3${_scopeId}></path></svg></div></section><section class="bg-white py-24" data-v-dd0c54e3${_scopeId}><div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-v-dd0c54e3${_scopeId}><div class="flex justify-center items-center min-h-[300px]" data-v-dd0c54e3${_scopeId}>`);
            if (aboutImageUrl.value && !aboutImageError.value) {
              _push2(`<img${ssrRenderAttr("src", aboutImageUrl.value)} alt="4B Grup Ürün Kataloğu" class="max-h-[500px] w-auto rounded-2xl shadow-2xl" data-v-dd0c54e3${_scopeId}>`);
            } else {
              _push2(`<div class="max-h-[500px] w-[400px] rounded-2xl bg-[#f4f5f6] border border-gray-200 flex items-center justify-center text-[#1B3163] font-semibold text-center px-6 py-12" data-v-dd0c54e3${_scopeId}>`);
              if (aboutImageError.value) {
                _push2(`<span data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.image_error"))}</span>`);
              } else {
                _push2(`<span data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.image_hint"))}</span>`);
              }
              _push2(`</div>`);
            }
            _push2(`</div><div data-v-dd0c54e3${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.about_label"))}</p><h2 class="text-4xl font-extrabold text-[#0e1e3d] leading-tight mb-5" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(c("about_title", "Hakkımızda"))}</h2><p class="text-gray-500 leading-relaxed mb-4 text-[15px]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(c("about_text1", "4B Grup, 2009 yılından bu yana otel, restoran, hastane ve toplu yemek tesislerine endüstriyel mutfak ekipmanları tedariki ve anahtar teslim proje hizmeti sunmaktadır. Yalnızca ekipman tedariği değil; tasarım, kurulum ve satış sonrası süreçlerin bütüncül yönetimini kapsayan kurumsal bir çözüm ortaklığı."))}</p><p class="text-gray-500 leading-relaxed mb-8 text-[15px]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(c("about_text2", "CE belgeli ürün portföyü, deneyimli proje mühendisleri ve 50'den fazla küresel markayla kurulan yetkili satış ve servis ortaklığıyla projenin her aşamasında teknik uzmanlık ve kalite güvencesi sağlanır."))}</p>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/kurumsal",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(c("about_btn", "Kurumsal Sayfamız"))} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(`</div></div></section><section class="bg-[#f4f5f6] py-24" data-v-dd0c54e3${_scopeId}><div class="max-w-7xl mx-auto px-6" data-v-dd0c54e3${_scopeId}><div class="text-center mb-14" data-v-dd0c54e3${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.products_label"))}</p><h2 class="text-4xl font-extrabold text-[#0e1e3d]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(c("cats_title", unref(trans)("home.cat_h")))}</h2><p class="text-gray-500 mt-4 text-[15px]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(c("cats_sub", unref(trans)("home.cat_sub")))}</p></div><div class="grid grid-cols-1 sm:grid-cols-3 gap-5" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(displayCategories.value, (cat) => {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative overflow-hidden aspect-square" data-v-dd0c54e3${_scopeId2}><img${ssrRenderAttr("src", FRAME_IMAGE)} alt="" draggable="false" class="absolute inset-0 w-full h-full object-cover pointer-events-none select-none" data-v-dd0c54e3${_scopeId2}><img${ssrRenderAttr("src", getCoverImage(cat.slug))}${ssrRenderAttr("alt", cat.name)} draggable="false" class="absolute inset-[7%] w-[86%] h-[86%] object-contain outline-none transition-transform duration-500 group-hover:scale-105" data-v-dd0c54e3${_scopeId2}></div><div class="px-4 py-3" style="${ssrRenderStyle({ "border-top": "1px solid #f0f1f3" })}" data-v-dd0c54e3${_scopeId2}><h3 class="font-bold text-sm leading-snug truncate" style="${ssrRenderStyle({ "color": "#1B3163" })}" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(cat.name)}</h3><span class="text-xs font-medium" style="${ssrRenderStyle({ "color": "#8b93a3" })}" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(cat.total_products_count ?? cat.products_count ?? 0)} ${ssrInterpolate(unref(trans)("common.product_unit"))}</span></div>`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></div><div class="text-center mt-10" data-v-dd0c54e3${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/urunler",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(c("cats_btn", unref(trans)("home.all_cats")))} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(`</div></div></section><section class="relative overflow-hidden py-0" data-v-dd0c54e3${_scopeId}><div class="absolute inset-0 flex" data-v-dd0c54e3${_scopeId}><div class="w-1/2 bg-[#0e1e3d]" data-v-dd0c54e3${_scopeId}></div><div class="w-1/2 bg-[#1B3163]" data-v-dd0c54e3${_scopeId}></div></div><div class="absolute inset-0 opacity-[0.03]" style="${ssrRenderStyle({ "background-image": "linear-gradient(rgba(255,255,255,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.15) 1px, transparent 1px)", "background-size": "40px 40px" })}" data-v-dd0c54e3${_scopeId}></div><div class="absolute inset-0 pointer-events-none" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse at 50% 50%, rgba(61,175,196,0.12) 0%, transparent 65%)" })}" data-v-dd0c54e3${_scopeId}></div><div class="relative max-w-7xl mx-auto px-6" data-v-dd0c54e3${_scopeId}><div class="flex flex-col lg:flex-row items-center gap-0" data-v-dd0c54e3${_scopeId}><div class="lg:w-5/12 flex justify-center lg:justify-end py-16 lg:py-12 lg:pr-12" data-v-dd0c54e3${_scopeId}><div class="relative" data-v-dd0c54e3${_scopeId}><div class="absolute -inset-6 rounded-3xl opacity-30" style="${ssrRenderStyle({ "background": "radial-gradient(circle, #3DAFC4 0%, transparent 70%)", "filter": "blur(24px)" })}" data-v-dd0c54e3${_scopeId}></div><div class="absolute top-2 left-3 w-full h-full bg-[#3DAFC4]/20 rounded-xl blur-sm" data-v-dd0c54e3${_scopeId}></div><div class="absolute top-1 left-1.5 w-full h-full bg-white/5 rounded-xl" data-v-dd0c54e3${_scopeId}></div><img src="/images/katalog-kapak.png" alt="4B Grup Ürün Kataloğu" class="relative z-10 w-64 sm:w-80 lg:w-72 xl:w-80 rounded-xl shadow-2xl" style="${ssrRenderStyle({ "box-shadow": "0 30px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.05)" })}" data-v-dd0c54e3${_scopeId}><div class="absolute -top-4 -right-4 z-20 w-16 h-16 bg-[#0E7A8C] rounded-full flex flex-col items-center justify-center shadow-lg border-4 border-[#0e1e3d]" data-v-dd0c54e3${_scopeId}><svg class="w-5 h-5 text-white mb-0.5" fill="currentColor" viewBox="0 0 20 20" data-v-dd0c54e3${_scopeId}><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd" data-v-dd0c54e3${_scopeId}></path></svg><span class="text-white text-[9px] font-black tracking-wide" data-v-dd0c54e3${_scopeId}>PDF</span></div></div></div><div class="lg:w-7/12 py-16 lg:py-20 lg:pl-12 text-center lg:text-left" data-v-dd0c54e3${_scopeId}><h2 class="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-5" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.catalog_title1"))}</h2><p class="text-white/55 text-[15px] leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.catalog_desc"))}</p><div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start" data-v-dd0c54e3${_scopeId}><a href="/files/katalog.pdf" download class="group inline-flex items-center justify-center gap-3 bg-[#0E7A8C] hover:bg-white text-white hover:text-[#1B3163] font-bold text-sm uppercase tracking-wide px-8 py-4 rounded-xl transition-all duration-300 shadow-lg shadow-[#3DAFC4]/20" data-v-dd0c54e3${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-dd0c54e3${_scopeId}></path></svg> ${ssrInterpolate(unref(trans)("home.catalog_download"))}</a>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/urunler",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(trans)("home.catalog_browse"))} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(`</div></div></div></div></section><section class="bg-white py-24" data-v-dd0c54e3${_scopeId}><div class="max-w-7xl mx-auto px-6" data-v-dd0c54e3${_scopeId}><div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14" data-v-dd0c54e3${_scopeId}><div data-v-dd0c54e3${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.projects_label"))}</p><h2 class="text-4xl font-extrabold text-[#0e1e3d]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.projects_h"))}</h2></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/projeler",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(trans)("home.projects_all"))} <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-dd0c54e3${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(__props.recentProjects.length ? __props.recentProjects : defaultProjects.value, (project, i) => {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(project.slug ? unref(Link) : "div"), mergeProps({
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="aspect-[4/3] relative overflow-hidden bg-[#f4f5f6]" data-v-dd0c54e3${_scopeId2}>`);
                    if (project.image_urls && project.image_urls[0]) {
                      _push3(`<img${ssrRenderAttr("src", project.image_urls[0])}${ssrRenderAttr("alt", unref(field)(project, "title") || project.title)} loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-v-dd0c54e3${_scopeId2}>`);
                    } else {
                      _push3(`<div class="w-full h-full flex items-center justify-center" style="${ssrRenderStyle(`background: linear-gradient(135deg, ${["#1B3163", "#0e2a5c", "#163060"][i % 3]} 0%, #1e3a72 100%)`)}" data-v-dd0c54e3${_scopeId2}><svg class="w-20 h-20 text-white/10" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="0.75" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" data-v-dd0c54e3${_scopeId2}></path></svg></div>`);
                    }
                    _push3(`<div class="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" data-v-dd0c54e3${_scopeId2}></div>`);
                    if (project.location) {
                      _push3(`<div class="absolute top-4 right-4 flex items-center gap-1.5 bg-[#0E7A8C] rounded-full px-3 py-1.5 shadow-sm" data-v-dd0c54e3${_scopeId2}><svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24" data-v-dd0c54e3${_scopeId2}><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" data-v-dd0c54e3${_scopeId2}></path></svg><span class="text-white text-[10px] font-bold tracking-wide" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(unref(field)(project, "location") || project.location)}</span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div><div class="p-6" data-v-dd0c54e3${_scopeId2}><h3 class="font-extrabold text-[#0e1e3d] text-lg leading-tight mb-2 group-hover:text-[#0E7A8C] transition-colors" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(unref(field)(project, "title") || project.title)}</h3><p class="text-gray-500 text-sm leading-relaxed line-clamp-2" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(unref(field)(project, "description") || project.description)}</p></div>`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></div></div></section><section class="bg-[#f4f5f6] py-20 overflow-hidden relative" data-v-dd0c54e3${_scopeId}><div class="max-w-7xl mx-auto px-6 mb-12" data-v-dd0c54e3${_scopeId}><div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4" data-v-dd0c54e3${_scopeId}><div data-v-dd0c54e3${_scopeId}><h2 class="text-4xl font-extrabold text-[#0e1e3d]" data-v-dd0c54e3${_scopeId}>${ssrInterpolate(unref(trans)("home.partners_section_h"))}</h2></div></div></div><div class="pointer-events-none absolute left-0 top-0 bottom-0 w-20 z-10" style="${ssrRenderStyle({ "background": "linear-gradient(to right, #f4f5f6, transparent)" })}" data-v-dd0c54e3${_scopeId}></div><div class="pointer-events-none absolute right-0 top-0 bottom-0 w-20 z-10" style="${ssrRenderStyle({ "background": "linear-gradient(to left, #f4f5f6, transparent)" })}" data-v-dd0c54e3${_scopeId}></div><div class="marquee-container group/marquee mb-4" data-v-dd0c54e3${_scopeId}><div class="marquee-track flex gap-4" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(2, (n) => {
              _push2(`<!--[--><!--[-->`);
              ssrRenderList(displayClients.value, (partner) => {
                ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(partner.website ? "a" : "div"), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (partner.logo_url) {
                        _push3(`<img${ssrRenderAttr("src", partner.logo_url)}${ssrRenderAttr("alt", partner.name)} loading="lazy" class="w-full h-24 object-contain transition-all duration-300" data-v-dd0c54e3${_scopeId2}>`);
                      } else {
                        _push3(`<div class="text-center" data-v-dd0c54e3${_scopeId2}><div class="w-12 h-12 bg-[#1B3163]/10 border border-[#1B3163]/20 rounded-lg flex items-center justify-center text-[#1B3163] font-extrabold text-sm mx-auto mb-1.5" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(getInitials(partner.name))}</div><span class="text-xs font-semibold text-[#1B3163]/60 leading-tight block" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(partner.name)}</span></div>`);
                      }
                    } else {
                      return [
            ...
            _push2(`<!--]--></div></div><div class="marquee-container-reverse group/marquee2" data-v-dd0c54e3${_scopeId}><div class="marquee-track-reverse flex gap-4" data-v-dd0c54e3${_scopeId}><!--[-->`);
            ssrRenderList(2, (n) => {
              _push2(`<!--[--><!--[-->`);
              ssrRenderList(displayPartners.value, (partner) => {
                ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(partner.website ? "a" : "div"), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (partner.logo_url) {
                        _push3(`<img${ssrRenderAttr("src", partner.logo_url)}${ssrRenderAttr("alt", partner.name)} loading="lazy" class="w-full h-14 object-contain transition-all duration-300" data-v-dd0c54e3${_scopeId2}>`);
                      } else {
                        _push3(`<div class="text-center" data-v-dd0c54e3${_scopeId2}><div class="w-12 h-12 bg-[#1B3163]/10 border border-[#1B3163]/20 rounded-lg flex items-center justify-center text-[#1B3163] font-extrabold text-sm mx-auto mb-1.5" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(getInitials(partner.name))}</div><span class="text-xs font-semibold text-[#1B3163]/60 leading-tight block" data-v-dd0c54e3${_scopeId2}>${ssrInterpolate(partner.name)}</span></div>`);
                      }
                    } else {
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd0c54e3"]]);
export {
  Home as default
};
